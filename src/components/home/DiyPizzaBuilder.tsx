  ...
  return (
    <div className="dark:bg-[#0f1115] bg-white border dark:border-white/5 border-neutral-200 rounded-3xl p-5 shadow-xl space-y-6 max-w-sm mx-auto font-sans font-bold">
      ...
      <div className="space-y-2.5 pt-2">
        <label className="text-[10px] font-black uppercase text-orange-500">{isHindi ? "2. सॉस और पनीर चुनें:" : "2. Choose Sauce & Cheese:"}</label>
      ...
      <div className="space-y-2.5 pt-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            { id: 'red_peprica', label: 'Red Paprika' },  
      ...
      <div className="space-y-2 pt-2">
        ...
        <textarea
          ...
          className="w-full text-xs p-3 rounded-xl dark:bg-white/[0.03] bg-neutral-50 border dark:border-white/5 border-neutral-300 text-neutral-950 dark:text-white outline-none focus:border-orange-500 h-16 resize-none"
        />
      </div>
