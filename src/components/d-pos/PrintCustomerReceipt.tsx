...
export default function PrintCustomerReceipt({ orderObj, currentUser }: PrintReceiptProps) {
  ...
  return (
    ...
    >
      ...
      <div className="text-[11px] font-bold pb-1.5 pt-1 border-b border-black flex justify-between">
        <span>Date: {orderDate.toLocaleDateString()}</span>
        <span>Time: {orderDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
      </div>

      {/* टोकन नंबर */}
      <div className="my-2 border-2 border-black py-1.5 text-center bg-white">
      ...
      {/* कस्टमर विवरण */}
      <div className="text-[11px] font-bold pb-1.5 pt-0.5 border-b border-black">
      ...
      <div className="py-1.5 border-b border-black">
        <div className="flex justify-between text-[11px] font-bold uppercase pb-1 border-b-2 border-dotted border-black">
      ...
      {orderObj.customerPhone && (
        <div className="py-1.5 border-b-2 border-dotted border-black text-[11px] leading-snug">
      ...
      {/* फुटर (बिलकुल साफ दिखने के लिए सही किया गया) */}
      <div className="pt-2 pb-4 text-center flex flex-col items-center justify-center">
