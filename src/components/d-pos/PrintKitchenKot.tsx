    ...
    <html>
      ...
      <body>
        ...
        <div className="center">
          <div style={{ fontSize: '11px', textTransform: 'uppercase' }}>TOKEN NUMBER</div>
        ...
        {orderObj.tableNumber && <div className="center bold" style={{ fontSize: '18px', marginTop: '2px' }}>TABLE: {orderObj.tableNumber}</div>}
